 ...
 * 
 * baris DINC - OH2UDS/TA7W : extended for communication between rx and tx picos used in N3B SDR Transceiver
 * 
 */
...
/**
 * \brief Function to be called from main, to activate slave mode
 * 
 */
