 ...
 *
 * This file contains the ILI9341 graphical display functions.
 *
 */
...
// void display_ili9341_graf(void);
// void display_ili9341_graf_top(void);
void display_ili9341_setup0(void);
void display_ili9341_setup(void);
void display_ili9341_countdown(bool show, uint16_t val);
// void display_ili9341_loop(void);

// void display_ili9341_aud_graf(void);


void display_ili9341_init(void);
void display_ili9341_test(void);

#endif //__DISPLAY_ILI9341_H
