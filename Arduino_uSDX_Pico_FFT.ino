...
void setup() {
  ...
  gpio_pull_up(GP_LNA);             // PTT pullup  (it takes about 1s to reach this point after power up / reset)
  gpio_set_dir(GP_LNA, GPIO_IN);    // PTT input (just to confirm) - true for out, false for in 
