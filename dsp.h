...
#ifdef PY2KLA_setup
#define EXCHANGE_I_Q  0    //include or remove this #define in case the LSB/USB and the lower/upper frequency of waterfall display are reverted - hardware I and Q pin dependent
#endif
