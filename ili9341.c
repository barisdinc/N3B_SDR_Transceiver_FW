...
uint16_t ili9341_pinCS = 12;//PICO_DEFAULT_SPI_CSN_PIN;
uint16_t ili9341_pinDC = 4;//20;
int16_t ili9341_pinRST = 5;//16;

uint16_t ili9341_pinSCK = 10;//PICO_DEFAULT_SPI_SCK_PIN;
uint16_t ili9341_pinTX = 11;//PICO_DEFAULT_SPI_TX_PIN;
