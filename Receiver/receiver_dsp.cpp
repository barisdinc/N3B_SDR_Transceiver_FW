...
// int16_t __not_in_flash_func(receiver_dsp :: apply_deemphasis)(int16_t x)
// {
//   if(deemphasis == 0)
//     return x;
...
void inline receiver_dsp :: iq_imbalance_correction(int16_t &i, int16_t &q)
{
    // if (iq_correction)
    // {
...
void receiver_dsp :: set_deemphasis(uint8_t deemph)
{
//   deemphasis = deemph;
}

void receiver_dsp :: set_agc_speed(uint8_t agc_setting)
{
...
void receiver_dsp :: set_frequency_offset_Hz(double offset_frequency)
{
...
void receiver_dsp :: set_mode(uint8_t val, uint8_t bw)
{
//   mode = val;
...
void receiver_dsp :: set_swap_iq(uint8_t val)
{
//   swap_iq = val;
}

void receiver_dsp :: set_iq_correction(uint8_t val)
{
//   iq_correction = val;
}

void receiver_dsp :: set_cw_sidetone_Hz(uint16_t val)
{
//   cw_sidetone_frequency_Hz = val;
}

void receiver_dsp :: set_gain_cal_dB(uint16_t val)
{
