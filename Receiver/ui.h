...
const uint8_t PIN_AB = 2;//20;
const uint8_t PIN_B  = 3;//21;
const uint8_t PIN_MENU = 7;//22;
const uint8_t PIN_BACK = 9;//17;
const uint8_t PIN_ENCODER_PUSH = 6;//5;
const uint8_t PIN_DISPLAY_SDA = 16;//18;
const uint8_t PIN_DISPLAY_SCL = 17;//19;
